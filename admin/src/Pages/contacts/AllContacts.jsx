...
const AllContacts = () => {
    const backend = 'https://www.api.parasenterprises.com/api/v1/get-contact';
    const deleteRoute = 'https://www.api.parasenterprises.com/api/v1/delete-contact/';
    const addMessageRoute = 'https://www.api.parasenterprises.com/api/v1/push-Message/';
