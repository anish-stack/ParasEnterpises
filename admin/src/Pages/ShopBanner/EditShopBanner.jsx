...
const EditShopBanner = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get(`http://localhost:7000/api/v1/get-all-sale-banner`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`http://localhost:7000/api/v1/update-sale-banner/${id}`, data);
