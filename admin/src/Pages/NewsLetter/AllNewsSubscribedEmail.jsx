...
const AllNewsSubscribedEmail = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get('http://localhost:7000/api/v1/get-all-subscribe-newsletter-email');
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`http://localhost:7000/api/v1/delete-newsletter-email/${selectedEmailId}`);
            handleFetch();
