          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                required
                className="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-xl sm:text-sm sm:leading-6"
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                required
                className="block w-full text-xl px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
              <button
                type="button"
